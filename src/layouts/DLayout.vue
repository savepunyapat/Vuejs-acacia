    ...
    >
      <div class="flex flex-wrap items-center justify-between">
        ...
        <div class="flex items-center lg:order-2">
          ...
          <!-- Dropdown menu -->
          <div
            class="z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
            id="apps-dropdown"
          >
            <div
              class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300"
          ...
          <div
            ...
            id="dropdown"
          >
            <!-- <div class="px-4 py-3" v-if="profile">
              <span class="block text-sm font-semibold text-gray-900 dark:text-white"
                >{{ profile.data.name }} - {{ profile.data.permission }}</span
              >
